...
# if [ `echo $1 | grep -c zip` -eq 0 ]; then echo "Argument is the file name, e.g. S1A....zip"; exit; fi
# if [ -z $2 ]; then echo "Second argument is the temporary outpath in nobackup"; exit; fi
