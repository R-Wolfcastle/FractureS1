...
model = UNet(1,2)
model.load_state_dict(torch.load('{}/256_edges_deepernet_epoch_10_bsv1_v1_epoch_2_sd'.format(os.environ['MODEL_DICT_DIR']),
...
def generate_damage(sar_tiff_filepath, outpath, seg_path, model, aoi=None, kernel=None, device="cpu"):
    ...
    array_to_geotiff(probs[1,:,:], sar_data, outpath+"/{}.damage_probs_1a.tif".format(date), compression="DEFLATE")
